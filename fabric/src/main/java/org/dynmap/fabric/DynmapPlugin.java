...
import org.dynmap.fabric.permissions.FilePermissions;
import org.dynmap.fabric.permissions.OpPermissions;
import org.dynmap.fabric.permissions.PermissionProvider;
    ...
    public void initializeBlockStates() {
        ...
        while (iter.hasNext()) {
            ...
            if (!bn.equals(DynmapBlockState.AIR_BLOCK)) {
				...
				if (FabricAdapter.VERSION_SPECIFIC.BlockState_isWaterlogged(bs)) {
					bld.setWaterlogged();
				}
