 ...
 */
public class MapChunkCache120_5 extends GenericMapChunkCache {
    private static final AsyncChunkProvider120_5 provider = BukkitVersionHelper.helper.isUnsafeAsync() ? null : new AsyncChunkProvider120_5();
    private World w;
    /**
     * Construct empty cache
     */
    public MapChunkCache120_5(GenericChunkCache cc) {
        super(cc);
    }
