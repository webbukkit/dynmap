 ...
 */
public class MapChunkCache120_4 extends GenericMapChunkCache {
    private static final AsyncChunkProvider120_4 provider = BukkitVersionHelper.helper.isUnsafeAsync() ? null : new AsyncChunkProvider120_4();
    private World w;
    /**
     * Construct empty cache
     */
    public MapChunkCache120_4(GenericChunkCache cc) {
        super(cc);
    }
    ...
    protected GenericChunk loadChunk(DynmapChunk chunk) {
        ...
        try {	// BUGBUG - convert this all to asyn properly, since now native async
            nbt = cw.getHandle().l().a.e(cc).join().get();	// playerChunkMap
