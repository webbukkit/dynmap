 ...
 *
 * See the header note in BukkitVersionHelperSpigot26_2 - this is a direct translation of
 * bukkit-helper-121-11's obfuscated (Spigot-mapped) calls to their real Mojang names, since
 * Minecraft 26.1+ ships unobfuscated and there is no more reobfuscated "spigot" jar to target.
 */
public class MapChunkCache26_2 extends GenericMapChunkCache {
	...
	protected GenericChunk getLoadedChunk(DynmapChunk chunk) {
		...
		// LevelChunk.loaded is private with no public getter in 26.2 - getChunkIfLoaded()
		// returning non-null already implies the chunk is loaded, so no extra check is needed.
		LevelChunk c = cw.getHandle().getChunkIfLoaded(chunk.x, chunk.z);
