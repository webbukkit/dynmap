...
@Deprecated
public class PostgreSQLMapStorageOld extends MapStorage {
    ...
    public PostgreSQLMapStorageOld() {
    }
    ...
    public class StorageTile extends MapStorageTile {
        ...
        public boolean getWriteLock() {
            return PostgreSQLMapStorageOld.this.getWriteLock(uri);
        }

        @Override
        public void releaseWriteLock() {
            PostgreSQLMapStorageOld.this.releaseWriteLock(uri);
        }

        @Override
        public boolean getReadLock(long timeout) {
            return PostgreSQLMapStorageOld.this.getReadLock(uri, timeout);
        }

        @Override
        public void releaseReadLock() {
            PostgreSQLMapStorageOld.this.releaseReadLock(uri);
        }
